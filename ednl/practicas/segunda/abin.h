...
template <typename T> class Abin {
    ...
    public:
        ...
        void preordenAbin(nodo n, const Abin<T>& A, void (*procesar)(Abin<T>::nodo, const Abin<T>&));
        void preordenAbin(nodo n, const Abin<T>& A);
...
template <typename T>
inline void Abin<T>::preordenAbin(Abin<T>::nodo n, const Abin<T>& A)
{
    if (n != Abin<T>::NODO_NULO)
    {
        ...
        preordenAbin(A.hijoIzqdoB(n), A);
        preordenAbin(A.hijoDrchoB(n), A);
    }
}
/*
 *template <typename T>
 *inline void Abin<T>::preordenAbin(Abin<T>::nodo n, const Abin<T>& A, void (*procesar)(Abin<T>::nodo, const Abin<T>&))
 *{
 *    if (n != Abin<T>::NODO_NULO)
 *    {
 *        procesar(n, A);
